<section class="promo">
        ...
        <ul class="promo__list">
            <? foreach ($data['categories'] as $key => $name_category): ?>
            <li class="promo__item promo__item--boards">
                <a class="promo__link" href="all-lots.html"><?=$name_category; ?></a>
            </li>
            <? endforeach; ?>
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$item['url_img']; ?>" width="350" height="260" alt="Сноуборд">
                </div>
                <div class="lot__info">
